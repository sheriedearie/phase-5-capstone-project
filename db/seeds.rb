...
review = Review.create(purchase: purchase1, rating: 5, comment:"This product is amazing, 10/10!", user_id: 1)
review = Review.create(purchase: purchase2, rating: 4, comment:"I love how easy it is to write in this!", user_id: 2)
review = Review.create(purchase: purchase3, rating: 3, comment:"The quality of these videos is immaculate.", user_id: 3)